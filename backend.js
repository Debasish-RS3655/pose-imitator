//pose imitator backend
//Debashish Buragohain
var express = require('express');
var app = express();
var bodyParser = require('body-parser');
const path = require('path');
const SerialPort = require('serialport');   //create an output port for connecting to the arduino
const Readline = require('@serialport/parser-readline');
const Serial = new SerialPort("COM7", { baudRate: 115200 }, function (err) {
    if (err) {
...
parser.on('data', function (req) {
    console.log("Received from COM7: ", req);
});
...
if (Serial !== null) {
    console.log("Connected to arduino at COM 7.");
